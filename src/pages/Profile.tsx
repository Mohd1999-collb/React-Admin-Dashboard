        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
              I am a passionate and results-driven software developer with a strong foundation in computer science and programming. With five years of experience in the industry, I have honed my skills in [programming languages, technologies, frameworks, etc.] and have a proven track record of delivering high-quality software solutions.
              </p>
            </div>
